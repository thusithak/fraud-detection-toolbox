!function($) {
    ...
    BootstrapTableFilter.DEFAULTS = {
        ...
        filterIcon: '<span class="glyphicon glyphicon-plus"></span>',
        refreshIcon: '<span class="glyphicon glyphicon-ok"></span>',
        clearAllIcon: '<span class="glyphicon glyphicon-remove"></span>',
        filtertableIcon: '<span class="glyphicon glyphicon-filter"></span>',
        addRecordsIcon: '<span class="glyphicon glyphicon-plus"></span>',
        ...
        this.$toolbar = $([
            '<div class="btn-toolbar">',
                ...
                '<div class="btn-group btn-group-filter-refresh">',
                    '<button id="addRecordsBtn" type="button" class="btn btn-default btn-primary btn-refresh" data-toggle="dropdown">',
                        this.options.addRecordsIcon,
                    ' Add Records</button>',
                '</div>',
            '</div>'
        ].join(''));
